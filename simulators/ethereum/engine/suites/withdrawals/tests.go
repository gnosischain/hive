...
var Tests = []test.SpecInterface{
	...
	&WithdrawalsExecutionLayerSpec{
		WithdrawalsBaseSpec: &WithdrawalsBaseSpec{
			Spec: test.Spec{
				Name: "Withdrawals Fork on Block 2 - 2 blocks withdrawals - 2 mass-claims - 16 / 1024 accs withdrawals per block",
				About: `
				- Shapella on block 2
				- 2 blocks with withdrawals
				- Claim accumulated withdrawals
	...
	&WithdrawalsExecutionLayerSpec{
		WithdrawalsBaseSpec: &WithdrawalsBaseSpec{
			Spec: test.Spec{
				Name: "Withdrawals Fork on Block 4 - 4 blocks withdrawals - 5 mass-claims - 64 / 64 accs withdrawals per block",
				About: `
				- Shapella on block 4
	...
	&WithdrawalsExecutionLayerSpec{
		WithdrawalsBaseSpec: &WithdrawalsBaseSpec{
			Spec: test.Spec{
				Name: "Withdrawals Fork on Block 10 - 1 blocks withdrawals - 2 mass-claims - 32 withdrawals per block",
				About: `
				- Shapella on block 10
				- 1 block with withdrawals
				- Claim accumulated withdrawals
				- Produce 1 additional pair (A, B) of blocks:
				  A: block with withdrawals
	...
	&WithdrawalsExecutionLayerSpec{
		WithdrawalsBaseSpec: &WithdrawalsBaseSpec{
			Spec: test.Spec{
				Name: "Withdrawals Fork on Block 2 - 8 blocks withdrawals - 2 mass-claims - 256 / (512 accs) withdrawals per block",
				About: `
				- Shapella on block 2
				- 8 blocks with withdrawals
				- Claim accumulated withdrawals
