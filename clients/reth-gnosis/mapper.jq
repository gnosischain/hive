...
. + {
  "config": {
    ...
    "consensus": "aura",
    "homesteadBlock": (env.HIVE_FORK_HOMESTEAD // "0")|to_int,
    "eip150Block": (env.HIVE_FORK_TANGERINE // "0")|to_int,
    "eip155Block": (env.HIVE_FORK_SPURIOUS // "0")|to_int,
    "byzantiumBlock": (env.HIVE_FORK_BYZANTIUM // "0")|to_int,
    "constantinopleBlock": (env.HIVE_FORK_CONSTANTINOPLE // "0")|to_int,
    "petersburgBlock": (env.HIVE_FORK_PETERSBURG // "0")|to_int,
    "istanbulBlock": (env.HIVE_FORK_ISTANBUL // "0")|to_int,
    "berlinBlock": (env.HIVE_FORK_BERLIN // "0")|to_int,
    "londonBlock": (env.HIVE_FORK_LONDON // "0")|to_int,
    "burntContract": {
